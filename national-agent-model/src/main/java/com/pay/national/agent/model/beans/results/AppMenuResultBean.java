...
public class AppMenuResultBean implements Serializable{
	...
	public String toString() {
		return "AppMenuResultBean [id=" + id + ", parentMenuId=" + parentMenuId + ", menuName=" + menuName
				+ ", menuLevel=" + menuLevel + ", jumpType=" + jumpType + ", imgUrl=" + imgUrl + ", h5Url=" + h5Url
				+ ", androidUrl=" + androidUrl + ", iosUrl=" + iosUrl + ", menuOrder=" + menuOrder + ", remark="
				+ remark + ", appMenus=" + appMenus + ", status=" + status + "]";
	}
}
